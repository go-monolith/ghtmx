...
const unknownTypeClassName = "--ghtmx-css-class-unknown-type"
...
// ComponentCSSClass is a ghtmx.CSS
...
// use ghtmx.Components skip rendering <style> elements for classes that are included in the global
// stylesheet. By default, the stylesheet path is /styles/ghtmx.css
func NewCSSMiddleware(next http.Handler, classes ...CSSClass) CSSMiddleware {
	return CSSMiddleware{
		Path:       "/styles/ghtmx.css",
