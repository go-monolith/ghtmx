// Package fixture is the fiber fixture application: a minimal app
...
import (
	...
	fiberadapter "github.com/go-monolith/ghtmx/adapters/fiber"
)
...
func NewApp() *fiberfw.App {
	app := fiberfw.New(fiberfw.Config{DisableStartupMessage: true})
