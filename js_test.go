...
func TestJSFuncCall(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			args:         nil,
			expected: ComponentScript{
				Name:       "jsFuncCall_0def6429a54a9c0d47cd9e6b6642eed9888e388c60696e9f923643a081052d81",
				Function:   "",
				Call:       "__ghtmx_invalid_js_function_name()",
				CallInline: "__ghtmx_invalid_js_function_name()",
			},
			expectedComponentOutput: `<script>__ghtmx_invalid_js_function_name()</script>`,
		},
		{
