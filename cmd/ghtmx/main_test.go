...
func TestMain(t *testing.T) {
	tests := []struct {
		...
		{
			name:           `"ghtmx version" prints version`,
			args:           []string{"templ", "version"},
			expectedStdout: ghtmx.Version() + "\n",
			expectedCode:   0,
		},
		{
