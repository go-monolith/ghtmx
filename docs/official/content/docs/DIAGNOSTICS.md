...
| ID | Cause | Remedy |
| --- | --- | --- |
| `GHTMX-W0101` | A fragment is never rendered or bound from any template. | Delete it — or, for a fragment rendered only from Go handlers (a supported pattern), keep it and accept the warning. |
