...
// Flush writes any buffered data to the underlying io.Writer and calls
// the Flush method of the underlying http.Flusher if it implements it,
// committing the HTTP response. Only the explicit ghtmx.Flush() streaming
// component reaches this; end-of-render release uses ReleaseBuffer, which
// drains without the http.Flusher cascade.
