...
func TestLocation(t *testing.T) {
	...
	const (
		want        = `{"uri":"file:///Users/gopher/go/src/github.com/go-monolith/ghtmx/internal/lsp/protocol/basic_test.go","range":{"start":{"line":25,"character":1},"end":{"line":27,"character":3}}}`
		wantInvalid = `{"uri":"file:///Users/gopher/go/src/github.com/go-monolith/ghtmx/internal/lsp/protocol/basic_test.go","range":{"start":{"line":2,"character":1},"end":{"line":3,"character":2}}}`
	)
	wantType := Location{
		URI: uri.File("/Users/gopher/go/src/github.com/go-monolith/ghtmx/internal/lsp/protocol/basic_test.go"),
		Range: Range{
			Start: Position{
				Line:      25,
				Character: 1,
