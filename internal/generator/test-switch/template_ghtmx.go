...
func render(input string) ghtmx.Component {
	return ghtmxruntime.GeneratedTemplate(func(ghtmx_7f3b9d1a_Input ghtmxruntime.GeneratedComponentInput) (ghtmx_7f3b9d1a_Err error) {
		...
		case "a":
			...
			if ghtmx_7f3b9d1a_Err != nil {
				return ghtmx.Error{Err: ghtmx_7f3b9d1a_Err, FileName: `internal/generator/test-switch/template.ghtmx`, Line: 6, Col: 17}
			}
		...
		default:
			...
			if ghtmx_7f3b9d1a_Err != nil {
				return ghtmx.Error{Err: ghtmx_7f3b9d1a_Err, FileName: `internal/generator/test-switch/template.ghtmx`, Line: 8, Col: 28}
			}
