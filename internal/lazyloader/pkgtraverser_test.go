...
func TestTemplPkgTraverserOpenTopologically(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			pkg: &packages.Package{
				OtherFiles: []string{"/foo.go", "/foo.ghtmx"},
			},
			wantErrContains: "read file \"/foo.ghtmx\"",
		},
		{
			...
			wantErrContains: "did open file \"/foo.ghtmx\"",
		},
		{
			name: "open a->b->c",
			traverser: &goPkgTraverser{
			...
			pkg: &packages.Package{
				PkgPath:    "a",
				OtherFiles: []string{"/a.ghtmx", "/a_other.ghtmx", "/a.go"},
				Imports: map[string]*packages.Package{
					"b": {
						PkgPath:    "b",
						OtherFiles: []string{"/b.ghtmx"},
						Imports: map[string]*packages.Package{
							"c": {
								PkgPath:    "c",
								OtherFiles: []string{"/c.ghtmx", "/c_other.ghtmx"},
							},
						},
					},
				},
		...
		},
		{
			...
			pkg: &packages.Package{
				PkgPath:    "a",
				OtherFiles: []string{"/a.ghtmx", "/a_other.ghtmx"},
				Imports: map[string]*packages.Package{
					"b": {
						PkgPath:    "b",
						OtherFiles: []string{"/b.ghtmx"},
...
func TestTemplPkgTraverserCloseTopologically(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			wantErrContains: "did close file \"/foo.ghtmx\"",
		},
		{
			name: "close a->b->c",
			traverser: &goPkgTraverser{
